...
public record BanStaffResult(string Notification, int? IsBan, BanStaffNotification BanStaffNotification);
public record BanStaffNotification(string Description, DateTime? CreatedAt, string Status, int? IsRead);
        ...
        CancellationToken cancellationToken)
    {
        ...
        if(staff is null || staff.RoleId != 3)
        {
            return new BanStaffResult("Không tìm thấy tài khoản staff phù hợp", 0,
                new BanStaffNotification("Không tìm thấy tài khoản staff phù hợp", 
        ...
        return new BanStaffResult("Cập nhật trạng thái tài khoản thành công", staff.IsBan, 
            new BanStaffNotification(userNotification.Description, userNotification.CreatedAt, 
