...
{
    public record CreateOwnerResponseFeedbackCommand(string Description, int UserId, int OwnerId, string Status, List<ImageResponseFeedbackDTO>? Images = null) : ICommand<CreateResponseFeedbackResult>;
