...
{
    public record CreateOwnerResponseFeedbackCommand(string Description, int UserId, int OwnerId, List<ImageResponseFeedbackDTO>? Images = null) : ICommand<CreateResponseFeedbackResult>;
