...
{
    public record GetOwnerResponseFeedbackByIdResponse(int Id, string Description, string Status, int UserId, int OwnerId, DateTime? CreatedAt, List<string> ImageUrls);
