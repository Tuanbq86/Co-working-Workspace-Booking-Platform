...
{
    public record UpdateOwnerStatusRequest(int UserId, string Message, string Status);
    ...
    public class UpdateOwnerStatusEndpoint : ICarterModule
    {
        public void AddRoutes(IEndpointRouteBuilder app)
        {
            ...
            {
                var command = new UpdateOwnerStatusCommand(id, request.UserId, request.Message, request.Status);
